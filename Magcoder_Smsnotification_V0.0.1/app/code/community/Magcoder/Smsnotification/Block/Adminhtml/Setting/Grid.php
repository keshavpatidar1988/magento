...
class Magcoder_Smsnotification_Block_Adminhtml_Setting_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('smsnotification_id', array(
            'header'    => Mage::helper('smsnotification')->__('I55555555555555'),
            'align'     =>'right',
            'width'     => '50px',
